...
public class ScoreReader extends RouteBuilder {
	...
	public void configure() throws Exception {
	    ...
	    from("file://"+inputFile+"?fileName=score.txt&noop=true").log("reads file")
	            ...
	            .process(new ScoreProcessors())
	            .log("toKafkaTopic")
	            .to(new KafkaUtil().buildKafkaEndpointUri(
	    	    		"kafka:redcard-enrollment-archives-score",groupId, sslKeystorePassword, sslKeystoreLocation, sslTruststoreLocation, sslTruststorePassword));
